    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <table width="100%">
                    ...
                    <tr>
                        <td height="20"></td>
                        <td align="center"><h2><font color="darkblue">MATRIZ FODA INSTITUCIONAL</font></h2></td>
                        <td height="20"</td>
                    </tr>
                    <tr><td height="5" colspan="3"></td></tr>
                    <tr>
                        <td align="left" colspan="3"> <a href="indexInsertarFloas.php">Insertar FLOAS</a> </td>
                    </tr>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    foreach ($listadoFloas as $est) {
                        echo "<tr>";
                        echo "<td>" . $est->getAreafloas() . "</td>";
                        echo "<td>" . $est->getDetallefloas() . "</td>";
                        echo "<td><a href='../controller/controller1.php?opcion=cargarFloas&idfloas=" . $est->getIdfloas() . "'>actualizar</a></td>";
                        echo "<td><a href='../controller/controller1.php?opcion=eliminarFloas&idfloas=" . $est->getIdfloas() . "'>eliminar</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
