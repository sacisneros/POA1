    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
             ...
             <table width="100%">
                    ...
                    <tr>
                        <td height="20"></td>
                        <td align="center"><h2><font color="darkblue">PONDERACIÓN DE OBJETIVOS</font></h2></td>
                        <td height="20"</td>
                    </tr>
                    <tr><td height="5" colspan="3"></td></tr>
                    <tr>
                        <td align="left" colspan="3"> <a href="insertarponderaciondeobjetivos.php">Insertar Ponderacion Objetivos</a> </td>
                    </tr>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <thead>
                    <tr>
                        ...
                        <th>Finalidad(Qué se va hacer?)</th>
                        <th>Propósito(Para qué se va hacer?)</th>
                        <th>Indicador Primario</th>
                        <th>Peso por importacia</th>
                        <th>Opciones</th>
                        <th>Opciones</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    foreach ($listadoPonderacion as $est) {
                        echo "<tr>";
                        echo "<td>" . $est->getPerspectivaestpon() . "</td>";
                        echo "<td>" . $est->getTipoobjpon() . "</td>";
                        echo "<td>" . $est->getFinalidadpon() . "</td>";
                        echo "<td>" . $est->getPropositopon() . "</td>";
                        echo "<td>" . $est->getIndicadorpripon() . "</td>";
                        echo "<td>" . $est->getPesoporimppon() . "</td>";
                        echo "<td><a href='../controller/controller1.php?opcion=cargarPonderacion&idponderacionobj=" . $est->getIdponderacionobj() . "'>actualizar</a></td>";
                        echo "<td><a href='../controller/controller1.php?opcion=eliminarPonderacion&idponderacionobj" . $est->getIdponderacionobj() . "'>eliminar</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
