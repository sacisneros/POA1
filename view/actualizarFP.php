...
session_start();
$finalidad = unserialize($_SESSION['finalidad']);
?>
<html lang="en">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <table width="100%" >
                    <tr>
                        <td width="20%"></td>
                        <td align="center"><h3><font color="darkblue">ACTUALIZAR ATRIBUTOS DEL OBJETIVO</font></h3></td>
                        <td width="20%"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td >
                            <form action="../controller/controller1.php">
                                ...
                                <input type="hidden" value="<?php echo $finalidad->getIdfp(); ?>" name="idfp">
                                <center>
                                    <table >
                                        ...
                                        <tr>
                                            <td align =center><textarea name="finalidadfp" style="width: 445px;" rows="5" cols="40" required><?php echo $finalidad->getFinalidadfp(); ?></textarea></td>                                                
                                        ...
                                        <tr>
                                            <td align =center><textarea name="propositofp" style="width: 445px;" rows="5" cols="40" required><?php echo $finalidad->getPropositofp(); ?></textarea></td>                                                
                                        ...
                                        <tr>
                                            <td align =center><textarea type="text" style="width: 445px;" rows="2" cols="40" name="coordinadorfp"  required><?php echo $finalidad->getCoordinadorfp(); ?></textarea></td>                                                
                                        </tr>
                                        <tr><td height="10"></td></tr>
                                        <tr>
                                            <td><b>Ejecutor:</b></td>
                                        ...
                                        <tr>
                                            <td align =center><textarea type="text" style="width: 445px;" rows="2" cols="40" name="ejecutorfp"  required><?php echo $finalidad->getEjecutorfp(); ?></textarea></td>
                                        </tr>
                                        <tr><td height="10"></td></tr>
