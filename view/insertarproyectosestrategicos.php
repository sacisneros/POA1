    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            <table  width="100%">
                <tr>
                    <td width="20%"></td>
                    <td align="center"><h3><font color="darkblue">PROYECTOS ESTRATÉGICOS</font></h3></td>
                     <td width="20%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../controller/controller1.php">
                            <input type="hidden" value="guardarproyectosestrategicos" name="opcion">
                            <center>
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea name="proyectoest" rows="2" cols="60" required></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea name="descripcionest" rows="3" cols="60" required></textarea></td> 
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea name="viabilidadest" rows="3" cols="60" required></textarea></td>
                                    <tr>
