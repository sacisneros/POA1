    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <table  width="100%">
                <tr>
                    <td width="20%"></td>
                    <td align="center"><h3><font color="darkblue">MATRIZ FODA INSTITUCIONAL</font></h3></td>
                    <td width="20%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../controller/controller1.php">
                            <input type="hidden" value="guardarfloas" name="opcion">
                            <center>
                                <table >
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <select name="areafloas" style="width: 445px;">
                                                ...
                                                <option>Limitaciones</option>
                                                <option>Estrategias de supervivencia</option>
                                                <option>Estrategias de re-orientacion</option>
                                                <option>Fortalezas</option>
                                                <option>Estrategias defensivas</option>
                                                <option>Estrategias ofensivas</option>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea style="width: 445px;" name="detallefloas" rows="5" cols="40" required></textarea></td>
                                    </tr>
                                    <tr>
                            ...
                            <center><input type="submit" value="Agregar Floas" ></center>
                        </form>
                    </td>
                    <td width="20%"></td>
                </tr>
