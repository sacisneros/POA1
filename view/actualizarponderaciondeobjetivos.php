                ...
                <tr>
                    ...
                    <td>
                        <form action="../controller/controller1.php">
                            <input type="hidden" value="actualizarPonderacion" name="opcion">
                            <input type="hidden" value="<?php echo $ponderacion->getIdponderacionobj(); ?>" name="idponderacionobj">
                            <center>
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea style="width: 445px;" name="perspectivaestpon" rows="2" cols="40" required><?php echo $ponderacion->getPerspectivaestpon(); ?></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea style="width: 445px;" name="tipoobjpon" rows="2" cols="40" required><?php echo $ponderacion->getTipoobjpon(); ?></textarea></td>                                                
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea style="width: 445px;" name="finalidadpon" rows="3" cols="40" required><?php echo $ponderacion->getFinalidadpon(); ?></textarea></td>                                                
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea style="width: 445px;" name="propositopon" rows="3" cols="40" required><?php echo $ponderacion->getPropositopon(); ?></textarea></td>                                                
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea style="width: 445px;" name="indicadorpripon" rows="3" cols="40" required><?php echo $ponderacion->getIndicadorpripon(); ?></textarea></td>                                                
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align =center><textarea style="width: 445px;" name="pesoporimppon" rows="3" cols="40" required><?php echo $ponderacion->getPesoporimppon(); ?></textarea></td>                                                
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                </table>
