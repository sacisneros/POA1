...
session_start();
$determinacion = unserialize($_SESSION['determinacion']);
?>
<html lang="en">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <table width="100%" >
                    <tr>
                        <td width="20%"></td>
                        <td align="center"><h3><font color="darkblue">ACTUALIZAR DETERMINACIÓN DE LA META</font></h3></td>
                        <td width="20%"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td >
                            <form action="../controller/controller1.php">
                                <input type="hidden" value="actualizarDM" name="opcion">
                                <input type="hidden" value="<?php echo $determinacion->getIddeterminacion(); ?>" name="idicr">
                                <center>
                                    <table >
                                        ...
                                        <tr>
                                            <td><input type="number" name="estandardeter" style="width: 445px;" value="<?php echo $determinacion->getEstandardeter(); ?>" required/></td>                                                
                                        ...
                                        <tr>
                                            <td ><input type="number" name="inferiordeter" style="width: 445px;" value="<?php echo $determinacion->getInferiordeter(); ?>" required/></td>                                                
                                        ...
                                        <tr>
                                            <td ><input type="number" name="basedeter" style="width: 445px;" value="<?php echo $determinacion->getBasedeter(); ?>"  required/></td>                                                
                                        ...
                                        <tr>
                                            <td ><input type="number" name="superiordeter" style="width: 445px;" value="<?php echo $determinacion->getSuperiordeter(); ?>"  required/></td>                                                
