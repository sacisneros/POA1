    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <table width="100%">
                    ...
                    <tr>
                        <td height="20"></td>
                        <td align="center"><h2><font color="darkblue">PROYECTOS ESTRATEGICOS</font></h2></td>
                        <td height="20"</td>
                    </tr>
                    <tr><td height="5" colspan="3"></td></tr>
                    <tr>
                        <td align="left" colspan="3"> <a href="insertarproyectosestrategicos.php">Insertar proyecto estratégico</a> </td>
                    </tr>
