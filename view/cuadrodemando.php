    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <table width="100%" >
                ...
                <tr>
                    <td height="20"></td>
                    <td align="center"><h2><font color="darkblue">CUADRO DE MANDO</font></h2></td>
                    <td height="20"></td>
                </tr>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th><font size="2">PERSPECTIVA</font></th>
                        <th><font size="2">TIPO DE OBJETIVO</font></th>
                        <th><font size="2">FINALIDAD</font></th>
                        <th><font size="2">PROPÓSITO</font></th>
                        <th><font size="2">INICIATIVAS</font></th>
                        <th><font size="2">INDICADOR</font></th>
                        <th><font size="2">L. INF.</font></th>                            
                        <th><font size="2">BASE</font></th>
                        <th><font size="2">L. SUP.</font></th> 
                    </tr>
                </thead>
                
                <tbody>
                    <?php
                    $listadoCuadro = $poaModel->getCuadroMando1();
                    foreach ($listadoCuadro as $cuad) {
                        echo "<tr>";
                        echo "<td><font size='2'>Perspectiva " . $cuad->getPerspectiva() . "</font></td>";
                        echo "<td><font size='2'>" . $cuad->getObjetivo() . "</font></td>";
                        echo "<td><font size='2'>" . $cuad->getFinalidad() . "</font></td>";
                        echo "<td><font size='2'>" . $cuad->getProposito() . "</font></td>";
                        echo "<td><font size='2'>";
                            echo "<table >";                                
                                    $listadoEstrategiasCM = $poaModel->getEstrategias();
                                    foreach ($listadoEstrategiasCM as $lcm) {
                                        if ($cuad->getIdambito()==$lcm->getIdambito()) {
                                            echo "<tr>";
                                            echo "<td><font size='2'>* ". $lcm->getDetalleestrategia()."</font></td>";
                                            echo "</tr>";
                                        }
                                    }                                
                            echo "</font></table>";
                        echo "</td>";
                        echo "<td><font size='2'>" . $cuad->getIndicador() . "</td>";
                        echo "<td bgcolor='red'><font size='2'>" . $cuad->getInferior() . "%</font></td>";
                        echo "<td bgcolor='yellow'><font size='2'>" . $cuad->getBase() . "%</font></td>";
                        echo "<td bgcolor='green'><font size='2'>" . $cuad->getSuperior() . "%</font></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
