    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <table  width="100%" >
                <tr>
                    <td width="20%"></td>
                    <td align="center"><h3><font color="darkblue">ESTRATEGIA</font></h3></td>
                    <td width="20%"></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <form action="../controller/controller1.php">
                            <input type="hidden" value="guardarambito" name="opcion">
                            <center>
                                <table >
                                    <tr>
                                    ...
                                    <tr>
                                        <td><b>Ingrese estrategia:</b></td>
                                    <tr>
                                        <td align =center><textarea name="detalleambito" rows="5" cols="60" required></textarea></td>
                                    </tr>
