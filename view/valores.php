    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            <table  width="100%">
                ...
                <tr>
                    <td width="15%"></td>
                    <td align="center"><h3><font color="darkblue">VALORES</font></h3></td>
                    <td width="15%"></td>
                </tr>
                <tr>
                    <td colspan="3" height="20"></td>
                ...
                <tr>
                    <td width="15%"></td>
                    <td align="center"><font size="4">Cada una de las actividades que la Cooperativa "SAN ANTONIO" Ltda.,  que en larealizaefectúa, son encaminadas en base a nuestros valores que se encuentran inmersos en el servicio financiero, no financiero y social que brindamos, como son:
                        Eficiencia, Honradez, Transparencia, Solidaridad, Responsabilidad, Comunicación y Cortesía, siendo requisito importante que nuestros asociados y empleados debemos poseer.</font></td>
                    <td width="15%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="15%"></td>
                    <td align="center"><h4><font color="darkblue">VALORES</font></h4></td>
                    <td width="15%"></td>
                </tr>
                <tr>
                    <td colspan="3" height="30"></td>
             ...
             <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            <td>EFICIENCIA</td>
                            <td>Garantizamos que nuestros productos agregan valor a los negocios de los clientes, por su excelencia y utilidad</td>
                        </tr>  
                         <tr>
                            <td>HONRADEZ</td>
                            <td>Nos caracterizamos por ser honestos en todas nuestras acciones</td>
                        </tr> 
                         <tr>
                            <td>TRANSPARENCIA</td>
                            <td>Todo lo que decimos lo cumplimos</td>
                        </tr> 
                         <tr>
                            <td>SOLIDARIDAD</td>
                            <td>Brindamos un servicio personalizado y oportuno enfocado en la satisfacción y bienestar de nuestros socios y clientes</td>
                        </tr>
                        <tr>
                            <td>RESPONSABILIDAD</td>
                            <td>Trabajamos con responsabilidad social para nuestros socios y comunidad en general</td>
                        </tr>
                    </tbody>
                </table>
            <table>
