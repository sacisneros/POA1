                            ...
                            <center>
                                <table border='1'>
                                    <tr>
                                        ...
                                        <td width="10"></td>
                                        <td align =center><textarea name="descripcionest" rows="2" cols="40" required></textarea></td>                                                
                                        <td width="20"></td>
                                    </tr>
                                    ...
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                         <td><b>Iniciativas estraégicas (Como se va hacer?):</b></td>
                                        <td width="10"></td>
                                        <td align =center><textarea name="descripcionest" rows="3" cols="40" required></textarea></td>                                                
                                        <td width="20"></td>
