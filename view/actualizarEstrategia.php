...
session_start();
$estrategia = $_SESSION['estrategia'];
?>
<html lang="en">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <table width="100%" >
                    <tr>
                        <td width="20%"></td>
                        <td align="center"><h3><font color="darkblue">ACTUALIZAR INICIATIVA ESTRATÉGICA</font></h3></td>
                        <td width="20%"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td >
                            <form action="../controller/controller1.php">
                                <input type="hidden" value="actualizarEstrategia" name="opcion">
                                <input type="hidden" value="<?php echo $estrategia->getIdestrategia(); ?>" name="idestrategia">
                                <center>
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <select name="idambito" style="width: 445px;">
                                                    <option>Elegir estrategia</option>
                                                    <?php
                                                    $poaModel = new PoaModel();
                                                    $listadoAmbito = $poaModel->getAmbitos();
                                                    foreach ($listadoAmbito as $amb) {
                                                        if ($amb->getIdambito() == $estrategia->getIdambito()) {
                                                            echo "<option value='" . $amb->getIdambito() . "' selected=true>" . $amb->getDetalleambito() . "</option>";
                                                        } else {
                                        ...
                                        <tr>
                                            <td align =center><textarea name="detalleestrategia" rows="5" cols="40" style="width: 445px;" required><?php echo $estrategia->getDetalleestrategia(); ?></textarea>
                                        </tr> 
                                        <tr>
