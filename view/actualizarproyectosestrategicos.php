...
session_start();
$proyecto = unserialize($_SESSION['proyecto']);
?>
<html lang="en">
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            <table  width="100%">
                <tr>
                    <td width="20%"></td>
                    <td align="center"><h3><font color="darkblue">ACTUALIZAR PROYECTOS</font></h3></td>
                    <td width="20%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../controller/controller1.php">
                            <input type="hidden" value="actualizarProyectoest" name="opcion">
                            <input type="hidden" value="<?php echo $proyecto->getIdproyectoest(); ?>" name="idproyectoest">
                            <center>
                                <table >
                                    <tr>
                                        <td><b>Proyecto Estratégico:</b></td>
                                    </tr>
                                    <tr>
                                        <td align =center><textarea name="proyectoest" style="width: 445px;" rows="2" cols="40" required><?php echo $proyecto->getProyectoest(); ?></textarea></td>
                                    ...
                                    <tr>
                                        <td align =center><textarea name="descripcionest" style="width: 445px;" rows="3" cols="40" required><?php echo $proyecto->getDescripcionest(); ?></textarea></td>                                                
                                        <td width="20"></td>
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                        <td><b>Umbral de Viabilidad:</b></td>
                                    </tr>
                                    <tr>
                                        <td align =center><textarea name="viabilidadest" style="width: 445px;" rows="3" cols="40" required><?php echo $proyecto->getViabilidadest(); ?></textarea></td>                                                
                            ...
                            <center><input type="submit" value="Actualizar Proyecto" ></center>
                        </form>
                    </td>
                    <td width="20%"></td>
                </tr>
