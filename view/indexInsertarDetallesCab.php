...
<html lang="en">
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <tr>
                    <td width="10%"></td>
                    <td align="center"><h3><font color="darkblue">PLAN DE ACCIÓN</font></h3></td>
                    <td width="10%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../controller/controller1.php">
                            <input type="hidden" value="guardarcabestrategia" name="opcion">
                            <input type="hidden" value="<?php echo $idestrategia; ?>" name="idestrategia">
                            ...
                            <center>
                                <table >
                                    ...
                                    <tr>
                                        <td><textarea name="perspectivacab" rows="2" cols="40" style="width: 300px;" required></textarea></td>                                                
                                        <td width="30"></td>
                                        <td><textarea name="objetivocab" rows="2" cols="40" style="width: 300px;" required></textarea></td>
                                    </tr>
                                    ...
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                        <td><textarea name="finalidadcab" rows="2" cols="30" style="width: 300px;" required></textarea></td>                                                
                                        <td width="30"></td>
                                        <td><textarea name="propositocab" rows="2" cols="30" style="width: 300px;" required><?php echo $estrategiaD; ?></textarea></td>
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                        <td><b>Iniciativa estratégica (¿Cómo se va hacer?):</b></td>
                                        <td width="30"></td>
                                        <td><b>Fecha de inicio del PAC:</b></td>
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                        <td><textarea name="iniciativacab" rows="2" cols="30" style="width: 300px;" required><?php echo $nombre; ?></textarea></td>                                                
                                        <td width="30"></td>
                                        <td><input type="date" name="fechaicab" style="width: 300px;" required/></td>   
                                    </tr>
                                    <tr>
                            ...
                            <center><input type="submit" value="Agregar Plan de acción" ></center>
                        </form>
                    </td>
                    <td width="10%"></td>
                </tr>
