                            ...
                            <center>
                                <table >
                                    <tr>
                                        ...
                                        <td width="10"></td>
                                        <td align =center><textarea name="proyectoest" rows="2" cols="40" required></textarea></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10"></td>
                                        <td align =center><textarea name="descripcionest" rows="3" cols="40" required></textarea></td>                                                
                                        <td width="20"></td>
                                    </tr>
                                    <tr><td height="10"></td></tr>
                                    <tr>
                                        ...
                                        <td width="10"></td>
                                        <td align =center><textarea name="viabilidadest" rows="3" cols="40" required></textarea></td>                                                
                                        <td width="10"></td>
                                    </tr>
                                    <tr>
