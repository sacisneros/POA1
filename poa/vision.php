    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            <table  width="100%">
                ...
                <tr>
                    <td width="15%"></td>
                    <td align="center"><h3><font color="darkblue">VISIÓN</font></h3></td>
                    <td width="15%"></td>
                </tr>
                <tr>
                    <td colspan="3" height="20"></td>
                ...
                <tr>
                    <td width="15%"></td>
                    <td align="center"><font size="4">Ser una Cooperativa de Ahorro y Crédito de reconocido prestigio en el sector financiero popular y solidario, 
                        de la sierra norte del país, por su transparente y eficiente desempeño financiero y social.</font></td>
                    <td width="15%"></td>
                </tr>
                <tr>
             ...
             <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            <td>SOLVENCIA</td>
                            <td>MANTENER RENTABILIDAD</td>
                        </tr>  
                         <tr>
                            <td>COMPETITIVIDAD</td>
                            <td>FORTALECER PRODUCTOS Y SERVICIOS</td>
                        </tr> 
                         <tr>
                         ...
                         <tr>
                            <td>CALIDAD</td>
                            <td>MAXIMIZAR EL SERVICIO AL SOCIO</td>
                        </tr>  
                         <tr>
                            <td>OBJETIVOS SOCIALES</td>
                            <td>CRECIMIENTO INSTITUCIONAL Y SOCIAL</td>
                        </tr>  
                    </tbody>
